...
const Shop = () => {
  ...
  const products = [
    // Grains & Cereals
    {
      ...
      inStock: true,
      description:
        "Premium quality aged Basmati rice from Punjab. Perfect for biryanis and pulavs.",
      origin: "Punjab, India",
    },
    {
      id: 2,
      ...
      inStock: true,
      description:
        "Stone-ground organic wheat flour, rich in nutrients and fiber.",
    ...
    // Fresh Vegetables
    {
      ...
      inStock: true,
      description:
        "Fresh, juicy tomatoes directly from organic farms. Perfect for cooking.",
    ...
    // Fruits
    {
      ...
      unit: "kg",
      image:
        "https://cdn.builder.io/api/v1/assets/dfb5e725ea9b4054b96bcf132975dc54/apple-2d2d61?format=webp&width=800",
      rating: 4.9,
      reviews: 445,
      discount: 17,
      inStock: true,
      description:
        "Premium Kashmir apples, crispy and sweet. Rich in vitamins.",
    ...
    },
    {
      ...
      inStock: true,
      description:
        "Sweet and tender corn kernels, perfect for cooking and snacking.",
      origin: "Karnataka, India",
    },
    // Dairy Products
    {
      ...
      unit: "litre",
      image:
        "https://cdn.builder.io/api/v1/assets/dfb5e725ea9b4054b96bcf132975dc54/g33-20c584?format=webp&width=800",
      rating: 4.7,
      reviews: 312,
      discount: 14,
      inStock: true,
      description:
        "Fresh cow milk from local dairy farms. Rich in calcium and proteins.",
      origin: "Punjab, India",
    },
    // Spices & Herbs
    {
      ...
      unit: "100g",
      image:
        "https://cdn.builder.io/api/v1/assets/dfb5e725ea9b4054b96bcf132975dc54/basil-e8b736?format=webp&width=800",
      rating: 4.5,
      reviews: 156,
      discount: 20,
      inStock: true,
      description:
        "Fresh organic basil leaves, perfect for cooking and medicinal use.",
      origin: "Kerala, India",
    },
    {
      id: 10,
      ...
      unit: "500g",
      image:
        "https://cdn.builder.io/api/v1/assets/dfb5e725ea9b4054b96bcf132975dc54/clover-0e75ac?format=webp&width=800",
      rating: 4.6,
      reviews: 98,
      discount: 20,
      inStock: true,
      description:
        "High-quality clover seeds for nitrogen fixation and soil improvement.",
    ...
    // Organic Products
    {
      ...
      unit: "kg",
      image:
        "https://cdn.builder.io/api/v1/assets/dfb5e725ea9b4054b96bcf132975dc54/beans-96d4aa?format=webp&width=800",
      rating: 4.6,
      reviews: 198,
      discount: 15,
      inStock: true,
    ...
    // Farm Tools & Soil
    {
      ...
      unit: "50kg bag",
      image:
        "https://cdn.builder.io/api/v1/assets/dfb5e725ea9b4054b96bcf132975dc54/soil-fdd45e?format=webp&width=800",
      rating: 4.3,
      reviews: 89,
      discount: 25,
      inStock: true,
      description:
        "Premium organic soil mix perfect for all types of plants and vegetables.",
      origin: "Maharashtra, India",
    },
    {
      id: 14,
      ...
      unit: "500ml",
      image:
        "https://cdn.builder.io/api/v1/assets/dfb5e725ea9b4054b96bcf132975dc54/pesticides-c9e4e9?format=webp&width=800",
      rating: 4.5,
      reviews: 156,
      discount: 18,
      inStock: true,
    ...
    },
    {
      ...
      unit: "1 litre",
      image:
        "https://cdn.builder.io/api/v1/assets/dfb5e725ea9b4054b96bcf132975dc54/oil-e0d16e?format=webp&width=800",
      rating: 4.7,
      reviews: 267,
      discount: 18,
      inStock: true,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              Fresh Indian Agricultural Products
            </h1>
            <p className="text-xl text-green-100 mb-8">
              Direct from farms to your doorstep • 100% Organic • Best Prices
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-green-100 text-sm">
                Premium Indian agricultural products delivered fresh from farms
                to your doorstep.
              </p>
            </div>
            <div>
              ...
              <div className="space-y-2 text-sm">
                <a href="#" className="block text-green-100 hover:text-white">
                  About Us
                </a>
                <a href="#" className="block text-green-100 hover:text-white">
                  Contact
          ...
          <div className="border-t border-green-800 pt-8 mt-8 text-center">
            <p className="text-green-200 text-sm">
              © 2024 Krishi Store. All rights reserved. | Connecting Farmers to
              Consumers
            </p>
          </div>
        </div>
